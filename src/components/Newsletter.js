	...
	render() {
		return(
			...
			<section className="mt-56 border font-in-border-blue border-current xl:mx-64 mx-1">
				...
				>
				<input className="appearance-none text-md md:text-2xl fw-300 text-center font-in-input-pink w-4/5 px-3 py-1 xl:p-5 mb-10 focus:outline-none focus:bg-gray-800 bg-gray-800 rounded-full font-in-border-blue border-4 tracking-widest" 
				id="emailCatch" 
				type="email" 
				name="email" 
