...
const Navbar = () =>  (
  ...
  <ul className="flex flex-wrap xl:flex-no-wrap xl:p-8 py-10 mx-auto items-center uppercase lato fw-300 tracking-widest space-x-5 xl:space-x-10 text-center text-white shadow-inner">
