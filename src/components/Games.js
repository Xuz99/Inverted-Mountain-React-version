...
const Game = (props) =>  (
	<div>
	<h2 className={props.custom_class + " mx-3 my-10 xl:max-w-full xl:mx-auto xl:mb-10 lato-thin uppercase text-center text-4xl xl:text-6xl shadow-lg lato fw-300"}>
	{props.title}
	</h2>
